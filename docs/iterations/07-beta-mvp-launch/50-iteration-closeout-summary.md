...
- Ingestion/feed Prisma persistence foundation for source items, cursors and feed read models, plus opt-in feed API runtime selector, has executable evidence through `npm run check:ingestion-feed-persistence`.
