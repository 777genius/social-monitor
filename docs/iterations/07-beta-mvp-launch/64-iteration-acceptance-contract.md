...
- Ingestion/feed Prisma persistence foundation plus feed API and ingestion-worker runtime selectors are gated by `npm run check:ingestion-feed-persistence`.
