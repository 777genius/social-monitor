...
- Ingestion/feed Prisma persistence foundation plus feed API, ingestion-worker and ingestion-support runtime selectors are gated by `npm run check:ingestion-feed-persistence`.
