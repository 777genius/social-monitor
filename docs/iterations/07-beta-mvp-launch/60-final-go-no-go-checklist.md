...
- Ingestion/feed Prisma persistence foundation and feed API runtime selector pass `npm run check:ingestion-feed-persistence`.
...
14. ingestion/feed persistence smoke for source items, cursors, feed read models and feed runtime selector, including `npm run check:ingestion-feed-persistence`
