...
- Acceptance: a new beta user can complete the core loop and submit classified feedback without engineering help; backend evidence is covered by `npm run check:mvp-core-loop`.
