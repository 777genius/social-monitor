# Interest Rules & User Configuration DSL

Date: 2026-05-31
Status: baseline interest/rule memory
...
2. Avoid OPA/Rego for end-user interest rules; reserve it for platform/security policy.
3. Keep all expressions bounded by execution limits and schema validation.

## Locked Decisions

1. Interest/summary rules are structured and versioned.
