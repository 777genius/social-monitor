# Interests Feature Agent Rules

This feature is the `interests` bounded context.
Read this file before changing anything under `apps/frontend/features/interests`.
...
docs/context_map.md
lib/social_monitor_interests.dart
lib/src/presentation/routes/interests_feature_route.dart
lib/src/presentation/composition/interests_feature_module.dart
lib/src/presentation/composition/interests_feature_module_host.dart
lib/src/presentation/pages/interests_feature_page.dart
```

## Bounded Context Purpose

Owns monitoring intent, interest name, backend query and interest lifecycle language.

## Growth Triggers

- create/edit/archive interest becomes a use case;
- advanced interest rules, markets, languages or monitoring intent need aggregates/value objects;
...
- another feature needs interest ids, route contracts or interest read models.
