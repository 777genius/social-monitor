...
void main() {
  testWidgets('period toolbar drives workspace summary period navigation', (
    ...
    final store = _store(workspaceSummary: readerSummaryApiDto());

    await _pumpFeature(tester, store);
...
SummariesReviewStore _store({required ReaderSummaryApiDto workspaceSummary}) {
