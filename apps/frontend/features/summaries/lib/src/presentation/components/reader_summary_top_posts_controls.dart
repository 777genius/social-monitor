  ...
  Widget build(BuildContext context) {
    return _TopPostControlSurface(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          _TopPostBoardToggleSegment(
            key: const ValueKey('reader-summary-top-posts-board-posts'),
            label: 'Top posts',
            count: postCount,
            selected: board == _TopPostBoard.posts,
            leading: const Icon(Icons.open_in_new_outlined, size: 14),
            onPressed: () => onChanged(_TopPostBoard.posts),
          ),
          _TopPostBoardToggleSegment(
            key: const ValueKey('reader-summary-top-posts-board-github'),
            ...
            onPressed: () => onChanged(_TopPostBoard.githubTrending),
          ),
        ],
      ),
    );
