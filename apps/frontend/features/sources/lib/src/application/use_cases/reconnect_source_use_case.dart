...
final class ReconnectSourceUseCase {
  const ReconnectSourceUseCase(this._catalog);

  final SourceCatalog _catalog;

  Future<Result<SourceSummary>> call(ReconnectSourceCommand command) {
    ...
    return _catalog.reconnectSource(command);
  }
}
