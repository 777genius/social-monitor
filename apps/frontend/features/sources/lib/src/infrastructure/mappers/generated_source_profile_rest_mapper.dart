...
final class GeneratedSourceProfileRestMapper {
  ...
  SourceProfileApiDto sourceProfile(generated.SourceProfileDto dto) {
    return SourceProfileApiDto(
      ...
      health: SourceProfileHealthApiDto(
        state: dto.health.state.toJson(),
        reasonCode: dto.health.reasonCode,
        message: dto.health.message,
        signals: dto.health.signals,
      ),
      ...
      unsupportedContentUnits: dto.unsupportedContentUnits,
