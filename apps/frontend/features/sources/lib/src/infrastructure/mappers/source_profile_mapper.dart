  ...
  SourceProfile toDomain(SourceProfileApiDto dto) {
    ...
    return SourceProfile(
      ...
      health: SourceProfileHealth(
        state: _safeText(dto.health.state, fallback: 'degraded'),
        reasonCode: _safeText(
          dto.health.reasonCode,
        ...
        signals: _safeList(dto.health.signals),
      ),
      ...
      unsupportedContentUnits: _safeList(dto.unsupportedContentUnits),
