...
SourceProfileApiDto sourceProfileApiDto({
  ...
  SourceProfileHealthApiDto health = const SourceProfileHealthApiDto(
    state: 'healthy',
  ...
  List<String> unsupportedContentUnits = const ['profile', 'media'],
  ...
  return SourceProfileApiDto(
    ...
    unsupportedContentUnits: unsupportedContentUnits,
