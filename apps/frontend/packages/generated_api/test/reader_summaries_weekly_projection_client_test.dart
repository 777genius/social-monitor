...
void main() {
  group('reader summaries weekly projection client', () {
    test('decodes a complete weekly model output with sealed provenance',
        () async {
      ...
      expect(response.schemaVersion.toJson(),
      ...
      expect(response.weekStartedOn, '2026-07-20');
      expect(response.weekEndedOn, '2026-07-26');
      ...
      expect(
        ...
        'reader_summary.weekly_model_output.v1',
      );
      ...
      expect(story.observedFrom, '2026-07-20');
      expect(story.observedThrough, '2026-07-26');
      ...
      expect(section.observedFrom, '2026-07-20');
      expect(section.observedThrough, '2026-07-26');
      expect(section.citationIds, ['citation-1']);
      expect(
        artifact.sections.map((value) => value.kind.toJson()).toList(),
        ['development', 'lead', 'why_it_matters', 'watch'],
      );
      expect(
      ...
      expect(citation.requestedUtcDate, '2026-07-20');
      ...
      expect(request.queryParameters, {'weekStartedOn': '2026-07-20'});
    ...
    test('preserves partial and unavailable evidence states without artifacts',
        () {
