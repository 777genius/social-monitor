...
part 'source_binding_daily_history_scheduler_skip_breakdown_response_dto.g.dart';

@JsonSerializable()
class SourceBindingDailyHistorySchedulerSkipBreakdownResponseDto {
  const SourceBindingDailyHistorySchedulerSkipBreakdownResponseDto({
  ...
  factory SourceBindingDailyHistorySchedulerSkipBreakdownResponseDto.fromJson(
  ...
  Map<String, Object?> toJson() =>
      _$SourceBindingDailyHistorySchedulerSkipBreakdownResponseDtoToJson(this);
}
