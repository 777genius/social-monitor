...
import 'interest_source_daily_history_summary_response_dto_provider_health_state_provider_health_state.dart';
import 'interest_source_daily_history_summary_response_dto_scan_coverage_state_scan_coverage_state.dart';

part 'interest_source_daily_history_summary_response_dto.g.dart';

@JsonSerializable()
class InterestSourceDailyHistorySummaryResponseDto {
  const InterestSourceDailyHistorySummaryResponseDto({
  ...
  factory InterestSourceDailyHistorySummaryResponseDto.fromJson(
    Map<String, Object?> json,
  ) => _$InterestSourceDailyHistorySummaryResponseDtoFromJson(json);
  ...
  final InterestSourceDailyHistorySummaryResponseDtoProviderHealthStateProviderHealthState
  providerHealthState;
  final num providerUnavailableScans;
  final num rateLimitedScans;
  final InterestSourceDailyHistorySummaryResponseDtoScanCoverageStateScanCoverageState
  scanCoverageState;
  ...
  Map<String, Object?> toJson() =>
      _$InterestSourceDailyHistorySummaryResponseDtoToJson(this);
}
