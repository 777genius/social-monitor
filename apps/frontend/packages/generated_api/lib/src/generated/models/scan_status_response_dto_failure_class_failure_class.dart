...
enum ScanStatusResponseDtoFailureClassFailureClass {
  ...
  const ScanStatusResponseDtoFailureClassFailureClass(this.json);

  factory ScanStatusResponseDtoFailureClassFailureClass.fromJson(String json) =>
  ...
  static List<ScanStatusResponseDtoFailureClassFailureClass>
