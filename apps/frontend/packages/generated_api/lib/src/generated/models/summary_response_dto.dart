...
import 'summary_response_dto_quality_flags_quality_flags.dart';
...
class SummaryResponseDto {
  ...
  factory SummaryResponseDto.fromJson(Map<String, Object?> json) =>
  ...
  final List<SummaryResponseDtoQualityFlagsQualityFlags> qualityFlags;
  ...
  Map<String, Object?> toJson() => _$SummaryResponseDtoToJson(this);
}
