...
@JsonEnum()
enum BriefingReaderQualityStateDtoFlagsFlags {
  @JsonValue('no_signal')
  noSignal('no_signal'),
  ...
  const BriefingReaderQualityStateDtoFlagsFlags(this.json);

  factory BriefingReaderQualityStateDtoFlagsFlags.fromJson(String json) =>
  ...
  static List<BriefingReaderQualityStateDtoFlagsFlags> get $valuesDefined =>
