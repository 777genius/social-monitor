...
@JsonEnum()
enum RecordSummaryFeedbackRequestDtoCategoryCategory {
  ...
  const RecordSummaryFeedbackRequestDtoCategoryCategory(this.json);

  factory RecordSummaryFeedbackRequestDtoCategoryCategory.fromJson(
    String json,
  ...
  static List<RecordSummaryFeedbackRequestDtoCategoryCategory>
