...
import 'reader_summary_response_dto_quality_flags_quality_flags.dart';
...
@JsonSerializable()
class ReaderSummaryResponseDto {
  ...
  factory ReaderSummaryResponseDto.fromJson(Map<String, Object?> json) =>
      _$ReaderSummaryResponseDtoFromJson(json);
  ...
  final List<ReaderSummaryResponseDtoQualityFlagsQualityFlags> qualityFlags;
  ...
  Map<String, Object?> toJson() => _$ReaderSummaryResponseDtoToJson(this);
}
