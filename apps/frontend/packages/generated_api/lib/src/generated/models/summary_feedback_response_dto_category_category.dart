...
@JsonEnum()
enum SummaryFeedbackResponseDtoCategoryCategory {
  ...
  const SummaryFeedbackResponseDtoCategoryCategory(this.json);

  factory SummaryFeedbackResponseDtoCategoryCategory.fromJson(String json) =>
  ...
  static List<SummaryFeedbackResponseDtoCategoryCategory> get $valuesDefined =>
