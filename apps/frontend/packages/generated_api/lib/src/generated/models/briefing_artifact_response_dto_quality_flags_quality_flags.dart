...
@JsonEnum()
enum BriefingArtifactResponseDtoQualityFlagsQualityFlags {
  @JsonValue('no_signal')
  noSignal('no_signal'),
  ...
  const BriefingArtifactResponseDtoQualityFlagsQualityFlags(this.json);

  factory BriefingArtifactResponseDtoQualityFlagsQualityFlags.fromJson(
    String json,
  ...
  static List<BriefingArtifactResponseDtoQualityFlagsQualityFlags>
