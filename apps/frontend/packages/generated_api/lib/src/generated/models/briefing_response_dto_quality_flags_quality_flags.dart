...
@JsonEnum()
enum BriefingResponseDtoQualityFlagsQualityFlags {
  @JsonValue('no_signal')
  noSignal('no_signal'),
  ...
  const BriefingResponseDtoQualityFlagsQualityFlags(this.json);

  factory BriefingResponseDtoQualityFlagsQualityFlags.fromJson(String json) =>
  ...
  static List<BriefingResponseDtoQualityFlagsQualityFlags> get $valuesDefined =>
