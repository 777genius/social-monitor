...
@JsonEnum()
enum ReaderSummaryArtifactResponseDtoQualityFlagsQualityFlags {
  @JsonValue('no_signal')
  noSignal('no_signal'),
  ...
  const ReaderSummaryArtifactResponseDtoQualityFlagsQualityFlags(this.json);

  factory ReaderSummaryArtifactResponseDtoQualityFlagsQualityFlags.fromJson(
    String json,
  ...
  static List<ReaderSummaryArtifactResponseDtoQualityFlagsQualityFlags>
