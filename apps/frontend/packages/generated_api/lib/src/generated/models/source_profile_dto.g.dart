...
SourceProfileDto _$SourceProfileDtoFromJson(
  ...
  liveBetaBlockers: (json['liveBetaBlockers'] as List<dynamic>)
      .map((e) => e as String)
      .toList(),
  liveEvidenceRequirements: (json['liveEvidenceRequirements'] as List<dynamic>)
      .map(
        (e) => SourceProfileLiveEvidenceRequirementDto.fromJson(
  ...
  runtimeReadiness: SourceProfileDtoRuntimeReadinessRuntimeReadiness.fromJson(
