...
@JsonEnum()
enum ReaderSummaryReaderQualityStateDtoFlagsFlags {
  @JsonValue('no_signal')
  noSignal('no_signal'),
  ...
  const ReaderSummaryReaderQualityStateDtoFlagsFlags(this.json);

  factory ReaderSummaryReaderQualityStateDtoFlagsFlags.fromJson(String json) =>
  ...
  static List<ReaderSummaryReaderQualityStateDtoFlagsFlags>
