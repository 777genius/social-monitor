  ...
  for path in "${BRIDGE_CONTROL_PATHS[@]}"; do
    ...
    case $path in
      ops/deploy/social-monitor-production-deploy.sh)
        ...
        alternate_digest_4=deda0e470e54ef9210adc6fa5a28095401dd7e9840f7e525887bbe2a56e377fc
        ;;
      ops/deploy/deploy-control-lib.sh)
      ...
      ops/deploy/deploy-control-bridge-lib.sh)
        ...
        alternate_digest_5=83c3f38bf4e27df1fd03ccc054e457fd4f328fbc49ccea137ac2754e930ed610
        ;;
    esac
