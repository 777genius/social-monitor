...
const allowedRolesByAction: Record<WorkspaceAction, readonly WorkspaceRole[]> = {
  ...
  'reader_summary_rejections.read': ['owner', 'admin'],
  'reader_summary_requests.create': ['owner', 'admin', 'member'],
  'reader_summary_topic_recommendations.decide': ['owner', 'admin'],
  ...
  'interests.archive': ['owner', 'admin'],
  'interests.create': ['owner', 'admin'],
  'interests.read': ['owner', 'admin', 'member', 'viewer'],
  'interests.update': ['owner', 'admin'],
