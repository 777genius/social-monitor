...
import {
  currentReaderSummaryPublicationFilter,
  listCompatibleReaderSummaryArtifacts,
  listReaderSummaryPeriodSummaries,
  rejectedReaderSummaryDebugFromPrisma,
} from "./prisma-reader-summary-artifact-queries";
import {
...
export class PrismaReaderSummaryArtifactRepository implements
  ...
  async list(
    query: Parameters<ReaderSummaryArtifactRepositoryPort["list"]>[0],
  ): ReturnType<ReaderSummaryArtifactRepositoryPort["list"]> {
    return listCompatibleReaderSummaryArtifacts(this.prisma, query);
  }

  async listPeriodSummaries(
    query: Parameters<ReaderSummaryArtifactRepositoryPort["listPeriodSummaries"]>[0],
  ): ReturnType<ReaderSummaryArtifactRepositoryPort["listPeriodSummaries"]> {
    return listReaderSummaryPeriodSummaries(this.prisma, query);
  }
  ...
  async findRejectedDebugById(
    ...
    return record === null ? null : rejectedReaderSummaryDebugFromPrisma(record);
  }
