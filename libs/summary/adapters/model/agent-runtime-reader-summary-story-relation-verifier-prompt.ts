...
export const agentRuntimeReaderSummaryStoryRelationVerifierInstructions = [
  ...
  "sameStory is true only when both posts describe the same actor, predicate, object, qualifiers, and concrete event.",
  ...
  "Posts from the same canonical provider family, or posts by the same author, must be false.",
  "Questions, rumors, predictions, and uncertain claims must be false unless an independent declarative body sentence repeats the same actor, predicate, object, and qualifier without speculation or negation.",
  "Quote, reply, comment, reaction, review, tutorial, comparison, benchmark, pricing, security, and availability posts must not be treated as origins of a different event facet.",
  "Conflicting canonical URLs or repositories, versions, dates, locations, outcomes, polarity, or event objects must be false.",
