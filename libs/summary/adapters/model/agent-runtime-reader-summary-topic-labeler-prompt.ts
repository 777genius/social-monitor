...
export const agentRuntimeReaderSummaryTopicLabelerInstructions = [
  ...
  "Every node and group label must be a standalone 1-4 word noun phrase, never a sentence or truncated headline clause.",
  ...
  return JSON.stringify(
    {
      ...
      constraints: {
        ...
        labelGrammar:
          "Standalone reader-facing noun phrase; no pronouns, action/reporting verbs, repeated words, or truncated headline syntax.",
        avoidGenericLabels: [
          "The",
          "Why",
          "What",
  ...
  properties: {
    nodeLabels: {
      ...
      items: {
        ...
        required: ["nodeId", "label", "groupId", "keywords"],
      },
    },
    groups: {
      type: "array",
