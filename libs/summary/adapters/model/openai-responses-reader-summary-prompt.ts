...
export const buildOpenAiReaderSummaryInstructions = (
  ...
  [
    ...
    "Keep the JSON response compact. Do not restate the same item in content, topStories, topicHighlights and risks. Prefer one clear sentence over long explanations.",
    ...
    "Return at most 5 topicHighlights, at most 5 repeatedSignals, at most 4 risksAndUnknowns and at most 10 citationMap entries. citationMap may include only the citations used by topStories.",
