...
const normalizeQualityState = (
  ...
  const record =
    value === undefined
      ? undefined
      : requiredRecord(value, 'reader brief quality state');
