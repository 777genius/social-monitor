...
import { readerPostPromotionDigest, sameOrderedStrings } from "./reader-summary-rest-attestation";
...
const readerSummaryReaderItemsView = (
  items: readonly CanonicalReaderSummaryArtifactView["content"]["topReads"][number][],
...
const readerSummaryReaderItemView = (
  item: CanonicalReaderSummaryArtifactView["content"]["topReads"][number],
  authority: ReaderCardRestAuthority,
  placement: "top" | "additional",
  slot: number,
...
type ReaderCardRestAuthority = Readonly<{
  ...
  clusters: ReadonlyMap<
    string,
    CanonicalReaderSummaryArtifactView["storyClusters"][number]
  >;
  promotionAttestations: ReadonlyMap<
    string,
    CanonicalReaderSummaryArtifactView["promotionAttestations"][number]
  >;
}>;
