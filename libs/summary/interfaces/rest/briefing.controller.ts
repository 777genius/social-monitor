...
export class BriefingController {
  constructor(
    ...
    private readonly getBriefing: GetBriefingUseCase,
  ...
  async list(
    ...
    const result = await this.listBriefings.execute({
  ...
  async get(
    ...
    const result = await this.getBriefing.execute({
      tenantId: scope.tenantId,
      workspaceId: scope.workspaceId,
      briefingId,
    });
