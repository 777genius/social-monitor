...
const buildInstructions = (): string =>
  [
    ...
    "Prefer reject for engagement-bait, promo, crypto-adjacent or weak topic match posts.",
...
const parseReviews = (
  ...
  return reviews.map((review) => {
    ...
    return {
      ...
      topicRelevanceScore: optionalScore(record.topicRelevanceScore),
    ...
    reviews: {
      ...
      items: {
        ...
        properties: {
          ...
          topicRelevanceScore: { type: "number", minimum: 0, maximum: 1 },
