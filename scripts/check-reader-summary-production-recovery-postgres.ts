...
const dailyLiveCanonicalCompatibilityMigration = "20260813085900_reader_summary_daily_live_canonical_preimage_compatibility";
...
const deferredCanonicalRecoveryMigrations = [
  ...
  dailyLiveCanonicalCompatibilityMigration,
] as const;
