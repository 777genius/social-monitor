...
import { reserveRecoveryInDisposableJournalForTest } from "./hn-rss-recovery-journal";
...
try {
  reserveRecoveryInDisposableJournalForTest(directory, digest, JSON.parse(scopeJson));
