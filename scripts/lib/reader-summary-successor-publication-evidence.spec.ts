/** No framework and no database: local evidence contract, with accepted supplemental producer input. */
...
console.log(JSON.stringify({ status: "local-contract-verified", nativePublication: "not-executed",
  githubBindings: 10, promotionVersion: "reader_post_promotion.v2", sqlCommandVersion: "reader_summary.publication_command.v2" }));
