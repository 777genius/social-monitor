...
const requiredGateIds = new Set([
  ...
  'interest-source-daily-history-rest',
  ...
  'github-repo-radar-ingestion-smoke',
  'github-trending-page-ingestion-smoke',
  'github-trending-page-html-e2e',
  ...
  'reader-summary-quality-regression',
  ...
  'summary-feedback-eval-backlog',
  'summary-memory-sdk',
  'summary-memory-sdk-package',
  'summary-memory-boundary',
  'summary-memory-feedback-loop',
  'summary-memory-preference-loop',
  'summary-memory-rich-context',
  'summary-memory-review-loop',
  'summary-memory-redaction',
  'summary-memory-product-loop',
  'summary-memory-runtime-canary-evidence',
