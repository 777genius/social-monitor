...
-- Extend the two existing lock-only refresh capabilities through 18 September.
-- No rows or relation privileges are changed.
BEGIN;
...
BEGIN
  IF target_tenant_id IS NULL OR target_workspace_id IS NULL OR target_date IS NULL
    ...
    OR target_date NOT IN (DATE '2026-08-30', DATE '2026-08-31', DATE '2026-09-01',
      ...
      DATE '2026-09-14', DATE '2026-09-15', DATE '2026-09-16', DATE '2026-09-17',
      DATE '2026-09-18')
