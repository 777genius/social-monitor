...
CREATE FUNCTION public."rollback_reader_summary_promotion_v2"(
  ...
  p_prior_v1_publication_id UUID,
  p_prior_v1_artifact_id UUID,
...
BEGIN
  ...
  SELECT * INTO STRICT v_prior
  FROM public."reader_summary_publications" publication
  WHERE publication."id" = p_prior_v1_publication_id
  FOR KEY SHARE;
  ...
  SELECT * INTO STRICT v_prior_artifact
  FROM public."reader_summary_artifacts" artifact
  WHERE artifact."id" = p_prior_v1_artifact_id
  FOR KEY SHARE;
  ...
  IF target_authority_receipt_format =
    ...
    AND NOT EXISTS (
      ...
      WHERE btrim(r."receipt_sha256") = target_authority_receipt_sha256
        ...
        AND r."prior_v1_publication_id" = p_prior_v1_publication_id
        AND r."prior_v1_artifact_id" = p_prior_v1_artifact_id
        ...
        AND r."receipt"->'rollbackAuthority'->>'priorPublicationId' =
          p_prior_v1_publication_id::TEXT
        AND r."receipt"->'rollbackAuthority'->>'priorArtifactId' =
          p_prior_v1_artifact_id::TEXT
  ...
  v_identity := encode(sha256(convert_to(jsonb_build_object(
    ...
    'priorV1PublicationId', p_prior_v1_publication_id::TEXT
  )::TEXT, 'UTF8')), 'hex');
  ...
  WHERE "id" = p_prior_v1_artifact_id
    AND "tenant_id" = target_tenant_id
    AND "workspace_id" = target_workspace_id
  ...
  SET "current_publication_id" = p_prior_v1_publication_id,
  ...
  IF v_updated <> 1 OR NOT EXISTS (
    ...
    WHERE slot."tenant_id" = target_tenant_id
      AND slot."workspace_id" = target_workspace_id
      AND slot."current_publication_id" = p_prior_v1_publication_id
      AND artifact."id" = p_prior_v1_artifact_id
  ...
  v_receipt := jsonb_build_object(
    ...
    'restoredPublicationId', p_prior_v1_publication_id::TEXT,
    'restoredArtifactId', p_prior_v1_artifact_id::TEXT,
  ...
  INSERT INTO public."reader_summary_promotion_v2_rollback_receipts" (
    ...
    p_prior_v1_publication_id, p_prior_v1_artifact_id,
